...
if __name__ == '__main__':
	...
	################################################
	fr_postive_3 = open('paths_Random/positive_path_3.txt', 'r')
	fr_negative_3 = open('paths_Random/negative_path_3.txt', 'r')
	...
	all_movie_3 = []  # save all the movies

	load_paths(fr_postive_3, True, counters[0])
	load_paths(fr_negative_3, False, counters[0])
	...
	model_train_2 = Train(model, iteration, learning_rate, paths_between_pairs, positive_label,all_variables, all_user, all_movie,3)
	embedding_dict_2 = model_train_2.train()


	print("Embedding 2")
	files = ['paths_Random/paths_between_pairs_3.txt', 'paths_Random/positive_label_3.txt']
	path_between_file = open(files[0], "w+")
	positive_label_file = open(files[1], "w+")
	all_movie_3=all_movie
	...
	files = ['paths_Random/node_count.txt_3', 'paths_Random/all_variables_3.txt', 'paths_Random/all_user_3.txt','paths_Random/all_movie_3.txt']
