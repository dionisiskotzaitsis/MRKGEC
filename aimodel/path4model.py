...
if __name__ == '__main__':
    ...
    ################################################
    fr_postive_4 = open('paths_Random/positive_path_4.txt', 'r')
    fr_negative_4 = open('paths_Random/negative_path_4.txt', 'r')
    ...
    load_paths(fr_postive_4, True, counters[1])
    load_paths(fr_negative_4, False, counters[1])
    ...
    model_train_3 = Train(model, iteration, learning_rate, paths_between_pairs, positive_label,
                              all_variables,
                              all_user, all_movie, 4)

    embedding_dict_3 = model_train_3.train()


    print("Embedding 4")
    print(len(embedding_dict_3))
    all_movie4 = all_movie
    files = ['paths_Random/paths_between_pairs_4.txt', 'paths_Random/positive_label_4.txt']
    ...
    files = ['paths_Random/node_count_4.txt', 'paths_Random/all_variables_4.txt', 'paths_Random/all_user_4.txt', 'paths_Random/all_movie_4.txt']
